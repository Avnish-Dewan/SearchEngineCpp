...
{
	ofstream fout;
	fout.open("/home/avnish/Desktop/crawler_backup/backup.txt",ofstream::trunc);
...
{
	ifstream fin;
	fin.open("/home/avnish/Desktop/crawler_backup/backup.txt");
	while(!fin.eof())
	{
...
{
	str[0]='\0';
	char temp[100]="/home/avnish/Desktop/sefiles/";
	char fno[100];
...
int findFileSize()
{
	...
	stat("/home/avnish/Desktop/se/temp.txt",&st); // temp.txt is the file where wget fetch the html
...
void copyFile()
{
	...
	//	cout<<endl<<endl<<endl<<str<<endl<<endl<<endl;
	  ...
	  ifstream fin;
	  ofstream fout;
	  fin.open("/home/avnish/Desktop/se/temp.txt");
	  fout.open(str);
...
void getPage(char *url)
{
	...
	strcat(urlbuffer,"/home/avnish/Desktop/se/temp.txt ");
